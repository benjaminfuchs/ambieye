...
(function(window, document) {
  ...
  function getSettingsFromGui() {
    ...
    settings["image.contrast"] = (document.getElementById("contrast").value / 100);
    settings["image.brightness"] = document.getElementById("camera_brightness").value;
    settings["image.exposure"] = document.getElementById("exposure").value;
    settings["image.saturation"] = (document.getElementById("saturation").value / 100);
    settings["image.white"] = document.getElementById("white").value;  
  }
}(this, this.document));
