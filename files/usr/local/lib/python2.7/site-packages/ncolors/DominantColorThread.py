...
class DominantColorThread(Thread):
    ...
    def run(self):
        ...
        self.blink()
        while not self._stop_event.wait(5) and not self._screenThread.ready():
        ...
        while not self._stop_event.is_set():
            ...
            x, y, w, h = self._screenThread.get_coordinates()
    ...
    def get_dominant_color(self, bgr_image, k=1, image_processing_size=None):
        """
