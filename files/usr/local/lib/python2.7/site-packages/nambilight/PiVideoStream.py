...
class PiVideoStream(Thread):
    ...
    def run(self):
        ...
        self._settings.log.msg("PiVideoStream: " + str(self._stream.get(cv2.CV_CAP_PROP_BRIGHTNESS)))
        self._settings.log.msg("PiVideoStream: " + str(self._stream.get(cv2.CV_CAP_PROP_ISO_SPEED)))
        ...
        self._stream.set(cv2.CAP_PROP_EXPOSURE, 100.0)
