...
class DominantColorThread(Thread):
    ...
    def run(self):
        ...
        while not self._stop_event.is_set():
            ...
            try:
                ...
                self._settings.set("led.color", [webcolors.rgb_to_hex(color_0), webcolors.rgb_to_hex(color_1), webcolors.rgb_to_hex(color_2)])
    ...
    def blink(self):
        self._settings.set("led.color", webcolors.rgb_to_hex([0, 0, 0]), webcolors.rgb_to_hex([0, 0, 0]), webcolors.rgb_to_hex([0, 0, 0]))
        self._stop_event.wait(0.3)
        self._settings.set("led.color", webcolors.rgb_to_hex([255, 255, 255]), webcolors.rgb_to_hex([255, 255, 255]) , webcolors.rgb_to_hex([255, 255, 255]))
        self._stop_event.wait(0.3)
        self._settings.set("led.color", webcolors.rgb_to_hex([0, 0, 0]), webcolors.rgb_to_hex([0, 0, 0]), webcolors.rgb_to_hex([0, 0, 0]))
    ...
    def get_dominant_color(self, bgr_image, image_processing_size=3):
        ...
        return rgb_image.tolist()[1][0], rgb_image.tolist()[0][1], rgb_image.tolist()[2][1]
