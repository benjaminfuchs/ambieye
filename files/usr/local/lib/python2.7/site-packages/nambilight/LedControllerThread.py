...
class LedControllerThread(Thread):
    ...
    def run(self):
        ...
        while not self._stop_event.wait(0.02):
            if self._settings.get("screen.ready") == "true":
                ...
                #     self._set_color_url(self._color_current)
    ...
    def on_color(self, name, old, new):
        ...
        self._color = new
        self._set_color_url(new[0], self._urls[2])
        self._set_color_url(new[0], self._urls[1])
        self._set_color_url(new[0], self._urls[0])
    ...
    def _set_color_url(self, value=None, url):
        """ Set the brightness of the leds """
